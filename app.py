...
def get_leagues():
    ...
    if res.status_code == 200:
        ...
        leagues = [
            ...
            for l in data if l['league']['type'] == 'League' and l['seasons'][-1]['year'] >= 2023
        ]
        return leagues
    else:
...
@st.cache_data
def get_upcoming_fixtures(league_id, season):
...
fixtures = get_upcoming_fixtures(selected['id'], selected['season'])
